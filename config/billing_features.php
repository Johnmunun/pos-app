...
return [
    ...
    */
    'catalog' => [
        ...
        'ecommerce.promotions' => [
            'label' => 'E-commerce promotions/coupons (campagnes actives max)',
            'group' => 'ecommerce',
            'type' => 'limit',
            'default_enabled' => false,
            'default_limit' => null,
        ...
        'promotions.products.max' => [
            'label' => 'Produits en promotion max (remise catalogue)',
            'group' => 'promotions',
            'type' => 'limit',
            'default_enabled' => true,
            'default_limit' => null,
        ...
        'promotions.advanced' => [
            'label' => 'Promotions avancées (types étendus)',
            'group' => 'promotions',
            'type' => 'boolean',
            'default_enabled' => false,
            'default_limit' => null,
        ...
        'loyalty.accounts.max' => [
            'label' => 'Cartes fidélité max (clients inscrits)',
            'group' => 'loyalty',
            'type' => 'limit',
            'default_enabled' => true,
            'default_limit' => null,
    ...
    */
    'plan_templates' => [
        'trial' => [
            'products.max' => ['label' => 'Produits max', 'enabled' => true, 'limit' => 2],
            'users.max' => ['label' => 'Utilisateurs max', 'enabled' => true, 'limit' => 2],
            'categories.max' => ['label' => 'Categories max', 'enabled' => true, 'limit' => 2],
            'suppliers.max' => ['label' => 'Fournisseurs max', 'enabled' => true, 'limit' => 1],
            'customers.max' => ['label' => 'Clients max', 'enabled' => true, 'limit' => 2],
            'depots.max' => ['label' => 'Depots max', 'enabled' => true, 'limit' => 1],
            ...
            'ai.product.image.generate' => ['label' => 'IA: génération image produit (titre + description)', 'enabled' => true, 'limit' => 1],
            'ai.media.image.generate' => ['label' => 'IA: génération image média CMS', 'enabled' => true, 'limit' => 1],
            'ai.product.seo.generate' => ['label' => 'IA: génération SEO produit (meta title, meta description, slug)', 'enabled' => true, 'limit' => 2],
            'ai.ecommerce.support' => ['label' => 'IA: support client e-commerce (livraison, retours, dispo, statut commande)', 'enabled' => true, 'limit' => 2],
            'ai.ecommerce.semantic_search' => ['label' => 'IA: recherche sémantique produits e-commerce', 'enabled' => true, 'limit' => 2],
            'multi.depot' => ['label' => 'Multi-depot', 'enabled' => true, 'limit' => 1],
            'sales.monthly.max' => ['label' => 'Ventes max (mois en cours)', 'enabled' => true, 'limit' => 2],
            ...
            'ecommerce.promotions' => ['label' => 'E-commerce promotions/coupons (campagnes actives max)', 'enabled' => true, 'limit' => 2],
            'promotions.products.max' => ['label' => 'Produits en promotion max (remise catalogue)', 'enabled' => true, 'limit' => 2],
            'promotions.advanced' => ['label' => 'Promotions avancées (types étendus)', 'enabled' => false, 'limit' => null],
            'loyalty.enabled' => ['label' => 'Programme fidélité', 'enabled' => false, 'limit' => null],
            'loyalty.accounts.max' => ['label' => 'Cartes fidélité max (clients inscrits)', 'enabled' => true, 'limit' => 50],
        ...
        'starter' => [
            ...
            'ecommerce.catalog' => ['label' => 'E-commerce catalogue', 'enabled' => true, 'limit' => null],
            'ecommerce.orders' => ['label' => 'E-commerce commandes', 'enabled' => true, 'limit' => null],
            'ecommerce.promotions' => ['label' => 'E-commerce promotions/coupons (campagnes actives max)', 'enabled' => false, 'limit' => null],
            'promotions.products.max' => ['label' => 'Produits en promotion max (remise catalogue)', 'enabled' => true, 'limit' => 10],
            'promotions.advanced' => ['label' => 'Promotions avancées (types étendus)', 'enabled' => false, 'limit' => null],
            'loyalty.enabled' => ['label' => 'Programme fidélité', 'enabled' => false, 'limit' => null],
            'loyalty.accounts.max' => ['label' => 'Cartes fidélité max (clients inscrits)', 'enabled' => true, 'limit' => 10],
        ...
        'pro' => [
            ...
            'ecommerce.catalog' => ['label' => 'E-commerce catalogue', 'enabled' => true, 'limit' => null],
            'ecommerce.orders' => ['label' => 'E-commerce commandes', 'enabled' => true, 'limit' => null],
            'ecommerce.promotions' => ['label' => 'E-commerce promotions/coupons (campagnes actives max)', 'enabled' => true, 'limit' => null],
            'promotions.products.max' => ['label' => 'Produits en promotion max (remise catalogue)', 'enabled' => true, 'limit' => null],
            'promotions.advanced' => ['label' => 'Promotions avancées (types étendus)', 'enabled' => true, 'limit' => null],
            'loyalty.enabled' => ['label' => 'Programme fidélité', 'enabled' => true, 'limit' => null],
            'loyalty.accounts.max' => ['label' => 'Cartes fidélité max (clients inscrits)', 'enabled' => true, 'limit' => null],
            'ecommerce.marketing.pro' => ['label' => 'E-commerce marketing Pro (pixels, tags, studio IA)', 'enabled' => true, 'limit' => null],
            'ecommerce.storefront.pro_themes' => ['label' => 'E-commerce vitrine : modèles Pro (en-tête & héro)', 'enabled' => true, 'limit' => null],
            'ecommerce.product.ai_vision' => ['label' => 'E-commerce : analyse IA de l\'image produit (titre, description, taille, etc.)', 'enabled' => true, 'limit' => null],
            'pharmacy.module' => ['label' => 'Module pharmacie', 'enabled' => true, 'limit' => null],
