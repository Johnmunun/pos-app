...
return [
    'pharmacy' => [
        'steps' => [
            ...
            [
                'id' => 'pharmacy-keyboard-shortcuts',
                'target' => '[data-onboarding="module-sidebar-nav"]',
                'title' => 'Raccourcis clavier',
                'content' => 'Maintenez Ctrl+Shift puis : V (nouvelle vente), D (dashboard), B (bons/achats), C (clients), P (produits), G (catégories). Consultez le Tutoriel pour la liste complète.',
                'order' => 4,
            ],
            [
    ...
    'commerce' => [
        'steps' => [
            ...
            [
                'id' => 'commerce-keyboard-shortcuts',
                'target' => '[data-onboarding="module-sidebar-nav"]',
                'title' => 'Raccourcis clavier',
                'content' => 'Maintenez Ctrl+Shift puis : V (nouvelle vente), D (dashboard), B (bons/achats), C (clients), P (produits), G (catégories). Consultez le Tutoriel pour la liste complète.',
                'order' => 2,
    ...
    'hardware' => [
        'steps' => [
            ...
            [
                'id' => 'hardware-keyboard-shortcuts',
                'target' => '[data-onboarding="module-sidebar-nav"]',
                'title' => 'Raccourcis clavier',
                'content' => 'Maintenez Ctrl+Shift puis : V (nouvelle vente), D (dashboard), B (bons/achats), C (clients), P (produits), G (catégories). Consultez le Tutoriel pour la liste complète.',
                'order' => 4,
