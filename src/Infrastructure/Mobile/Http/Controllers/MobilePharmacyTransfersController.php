...
class MobilePharmacyTransfersController
{
    public function index(Request $request): JsonResponse
    {
        ...
        $transfers = $transferRows->take($limit)->map(fn (StockTransferModel $t) => [
            'id' => (string) $t->id,
            ...
            'total_quantity' => (int) $t->items()->sum('quantity'),
        ])->values();
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        ...
        $transfer = StockTransferModel::query()
            ->where('id', $id)
            ->where(function ($q) use ($shopId) {
                $q->where('from_shop_id', (int) $shopId)
                    ->orWhere('to_shop_id', (int) $shopId);
            ...
            ->with([
                ...
                'fromShop:id,name',
                'toShop:id,name',
                'items.product:id,name,code,stock',
            ])
            ->first();
