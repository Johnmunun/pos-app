        ...
        return DB::table('billing_plans')
            ...
            ->map(function ($plan) {
                ...
                return [
                    ...
                    'annual_price' => $annual,
                    'platform_take_rate_percent' => isset($plan->platform_take_rate_percent) ? (float) $plan->platform_take_rate_percent : 0.0,
                    'withdrawal_fee_percent' => isset($plan->withdrawal_fee_percent) ? (float) $plan->withdrawal_fee_percent : 0.0,
    ...
    public function updatePlan(int $planId, array $payload): void
    {
        ...
        DB::table('billing_plans')
            ...
            ->update([
                ...
                'platform_take_rate_percent' => $payload['platform_take_rate_percent'] ?? 0,
                'withdrawal_fee_percent' => $payload['withdrawal_fee_percent'] ?? 0,
