 ...
 * Pour Quincaillerie, les quantités peuvent être décimales.
 */
class InventoryItem
{
    private string $id;
     ...
     */
    public function updateCountedQuantity(float $countedQuantity): void
    {
        $this->countedQuantity = $countedQuantity;
    ...
    {
        return abs($this->difference) > 0.0001; // Tolérance pour les comparaisons de float
    }
