...
@section('title', 'Fiche de Mouvement de Stock (Commerce)')
...
@section('content')
        ...
        <table class="data-table" style="margin-top: 8px;">
            <thead>
                <tr>
                    ...
                    <th class="align-right" style="width: 13%;">Prix vente</th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <div style="margin-top: 30px; padding: 10px; background: #f8f9fa; border-radius: 4px; font-size: 9px; color: #666;">
        <strong>Note :</strong> Ce document constitue une trace officielle du mouvement de stock (Commerce).
