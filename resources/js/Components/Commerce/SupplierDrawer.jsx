    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                toast.success(response.data.message || (isEditing ? 'Fournisseur mis à jour' : 'Fournisseur créé'));
                onClose();
                if (onSuccess) {
                    onSuccess();
                }
                ...
                <div className="flex-1 overflow-y-auto space-y-4">
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            placeholder="Ex: Grossiste Distribution SARL"
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            placeholder="Ex: contact@grossiste.com"
                            className="mt-1 bg-white dark:bg-slate-800 border-gray-300 dark:border-slate-600 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
                            disabled={processing}
                        />
                        {errors.email && (
