                        ...
                        {availableRoles.length === 0 ? (
                            <div className="rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20 p-3 text-sm text-amber-800 dark:text-amber-200">
                                ...
                                <p className="text-xs opacity-90">
                                    Des rôles système (ex. « Vendeur Commerce ») peuvent être créés par l'administrateur une fois ; ils apparaîtront ici pour tous les propriétaires. Sinon, créez un rôle dans <strong>Admin → Gestion des accès → Rôles</strong> avec des permissions {sectorLabel} uniquement.
                                </p>
                            </div>
                        ) : (
                            <>
