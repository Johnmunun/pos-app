...
export default function EcommerceCategoryDrawer({ isOpen, onClose, category = null, parentOptions = [] }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (isEditing && category?.id) {
            post(route('ecommerce.categories.update', category.id), {
            ...
            post(route('ecommerce.categories.store'), {
                preserveScroll: false,
                data: {
                    name: data.name,
