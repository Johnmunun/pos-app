...
import SellerDrawer from '@/Components/Commerce/SellerDrawer';
...
export default function SellersIndex({ sellers = [], availableRoles = [], availableDepots = [], stats = {}, allPermissions = {} }) {
    ...
    const handleConfirmImpersonate = async () => {
        ...
        try {
            ...
            router.visit(res.data?.redirect || route('commerce.sales.index'));
        } catch (error) {
                        ...
                        <div className="mb-4 rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20 p-3 flex items-start gap-2 text-sm text-amber-800 dark:text-amber-200">
                            ...
                            <div>
                                ...
                                <p className="text-xs mt-1 opacity-90">
                                    L'administrateur peut créer des rôles système (ex. « Vendeur Commerce ») une fois ; ils seront visibles ici pour tous. Sinon, créez des rôles pour votre boutique avec des permissions de votre secteur.
