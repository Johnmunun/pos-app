...
export default function CommerceDepotsIndex({ depots = [] }) {
    ...
    const canManage = isRoot || hasAllPermissions || permissions.includes('module.commerce');
    ...
    const handleSubmit = (e) => {
        ...
        const url = editingDepot
            ? route('commerce.depots.update', editingDepot.id)
            : route('commerce.depots.store');
    ...
    const handleToggleActive = (depot) => {
        const routeName = depot.is_active ? 'commerce.depots.deactivate' : 'commerce.depots.activate';
                        ...
                        {depots.length === 0 ? (
                            <div className="py-12 text-center">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 mb-4">
                                    Créez votre premier dépôt pour commencer. Chaque dépôt peut être lié à une boutique (shop) pour isoler les produits et ventes.
                                </p>
                                {canManage && (
                                    <Button onClick={handleOpenCreate} className="gap-2">
                                        <Plus className="h-4 w-4" />
