...
export default function CommerceTransfersIndex({ transfers = [], shops = [], filters = {}, stats = {} }) {
    ...
    const handleSearch = (e) => {
        ...
        Object.keys(searchFilters).forEach((key) => {
            if (searchFilters[key]) params[key] = searchFilters[key];
        });
        router.get(route('commerce.transfers.index'), params);
    };
    ...
    const resetFilters = () => {
        ...
        router.get(route('commerce.transfers.index'));
    };
                            ...
                            <CardContent className="pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">{stats.draft ?? 0}</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-green-600 dark:text-green-400">{stats.validated ?? 0}</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                                            ...
                                            {transfers.map((transfer) => (
                                                <tr key={transfer.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                                                    <td className="py-3 px-4">
                                                        <span className="font-mono font-medium text-blue-600 dark:text-blue-400">{transfer.reference}</span>
                                                    </td>
                                                    <td className="py-3 px-4">
                                                    ...
                                                    <td className="py-3 px-4 text-center">{getStatusBadge(transfer.status)}</td>
                                                    <td className="py-3 px-4 text-center">
                                                        <span className="text-sm font-medium text-gray-900 dark:text-white">{transfer.total_items}</span>
                                                    ...
                                                    <td className="py-3 px-4 text-sm text-gray-700 dark:text-gray-300">{transfer.created_by_name}</td>
                                                    <td className="py-3 px-4">
                                                        <div className="flex justify-center gap-2">
                                                            <Link href={route('commerce.transfers.show', transfer.id)}>
