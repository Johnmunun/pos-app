...
export default function InventoryIndex({ inventories, filters = {}, pagination, permissions }) {
    ...
    const handleFilterSubmit = (e) => {
        e.preventDefault();
        router.get(route('commerce.inventories.index'), {
    ...
    const handleCreateInventory = () => {
        router.post(route('commerce.inventories.store'));
    };
                        ...
                        <CardContent>
                            {inventories.length === 0 ? (
                                <div className="text-center py-12">
                                    ...
                                    {permissions?.create && Object.keys(filters).filter(k => filters[k]).length === 0 && (
                                            ...
                                            {inventories.map((inventory) => (
                                                <tr key={inventory.id} className="hover:bg-gray-50 dark:hover:bg-slate-800">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        {permissions?.view && (
                                                            <Link
                                                                href={route('commerce.inventories.show', inventory.id)}
