...
export default function InventoryShow({ inventory, items, stats, categories = [], permissions }) {
    ...
    const handleSaveCounts = async () => {
        ...
        try {
            ...
            await axios.post(route('commerce.inventories.counts', inventory.id), {
                counts: countsToSave,
            });
    ...
    const handleStart = () => {
        router.post(route('commerce.inventories.start', inventory.id));
    };

    const handleValidateClick = () => setShowValidateModal(true);
    const handleValidateConfirm = () => {
        setShowValidateModal(false);
        router.post(route('commerce.inventories.validate', inventory.id));
    };

    const handleCancelClick = () => setShowCancelModal(true);
    const handleCancelConfirm = () => {
        setShowCancelModal(false);
        router.post(route('commerce.inventories.cancel', inventory.id));
    };
