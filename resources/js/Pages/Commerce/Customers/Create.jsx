...
export default function CommerceCustomersCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('commerce.customers.store'));
    };
            ...
            header={
                <div className="flex items-center">
                    ...
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">
                        Nouveau client — Global Commerce
                    </h2>
                </div>
            }
        >
            <Head title="Nouveau client - Commerce" />
            <div className="py-6">
                <div className="max-w-xl mx-auto sm:px-6 lg:px-8">
                    <Card>
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2">
                                <Users className="h-5 w-5" /> Créer un client
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="flex flex-col-reverse sm:flex-row gap-2 sm:gap-4 pt-4">
                                    ...
                                    >
                                        <Link href={route('commerce.customers.index')}>Annuler</Link>
                                    </Button>
                                    <Button
                                        type="submit"
                                        disabled={processing}
