                                    ...
                                    <Link
                                        ...
                                        className={`px-3 py-2 rounded-xl text-xs font-semibold transition-colors ${
                                            page?.slug === p.slug
                                                ...
                                                : 'text-neutral-950 dark:text-neutral-100 hover:text-[var(--sf-primary,#d97706)] dark:hover:text-[var(--sf-primary,#fbbf24)] hover:bg-slate-100/80 dark:hover:bg-slate-800/60'
                                        }`}
                                    >
                                        {p.title}
                                    </Link>
