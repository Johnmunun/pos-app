...
export default function ResetPassword({ token, email }) {
    ...
    const inputClass =
        'w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all shadow-sm';
    const labelClass = 'text-gray-900 dark:text-gray-100 font-semibold mb-2 block text-sm';
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 space-y-6 transition-all duration-200">
                        <form onSubmit={submit} className="space-y-6">
                            <div>
                                <InputLabel htmlFor="email" value="Adresse email" className={labelClass} />
                                <TextInput
                                    id="email"
                                    type="email"
                                    name="email"
