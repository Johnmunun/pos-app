    ...
    >
      ...
      <div className="py-8 sm:py-10 space-y-8 sm:space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-5">
            {/* VENTES DU JOUR */}
            <Card
              data-onboarding="pharmacy-sales-card"
            ...
            {/* VALEUR DU STOCK */}
            <Card
              data-onboarding="pharmacy-stock-value"
              ...
              <CardContent className="p-5 sm:p-6">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-white text-2xl sm:text-3xl font-bold tabular-nums mb-2">{fmt(stats?.inventory?.total_value ?? 0)}</p>
            ...
            <Card className="overflow-hidden rounded-2xl border-0 bg-gradient-to-br from-red-500 to-red-600 dark:from-red-600 dark:to-red-800 shadow-landing-soft-lg">
              <CardContent className="p-5 sm:p-6">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    <p className="text-red-100/95 text-xs font-semibold uppercase tracking-wide mb-2">Expire bientôt</p>
                    <p className="text-white text-2xl sm:text-3xl font-bold tabular-nums mb-2">{stats?.expiry?.expiring_soon_count ?? 0}</p>
                    <p className="text-red-100/85 text-xs">Sous 30 jours</p>
                  </div>
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white/15 ring-1 ring-white/20">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const csvLines = [
                        // En-tête principal
                        ['RAPPORT DE VENTES - MODULE PHARMACIE'],
                        [''],
                      ...
                      a.href = url;
                      const fileName = `rapport-ventes-pharmacie-${now.toISOString().slice(0, 10)}.csv`;
                      a.download = fileName;
                      a.click();
          ...
          {visibleActions.length > 0 && (
            <Card
              data-onboarding="pharmacy-quick-actions"
              className="hidden overflow-hidden rounded-2xl border border-gray-200/80 bg-white/95 shadow-landing-soft backdrop-blur-sm dark:border-slate-700/80 dark:bg-slate-900/80 md:block"
            >
              <CardHeader className="pb-3">
