          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="bg-gradient-to-br from-red-500 to-red-600 dark:from-red-600 dark:to-red-700 border-0 shadow-lg">
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <p className="text-red-100 text-sm font-medium mb-2">EXPIRE BIENTÔT</p>
                    <p className="text-white text-3xl font-bold mb-2">{stats?.expiry?.expiring_soon_count ?? 0}</p>
                    <p className="text-red-100 text-xs mt-2">Sous 30 jours</p>
                  </div>
                  <div className="w-14 h-14 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
